        ...
        return datatables()
            ...
            ->addColumn('action', function ($item) {
                return implode('', [
                    ...
                    '<a href="' . route('wallets.show', $item->id) . '" class="btn btn-primary" title="' . __('Show') . '"><i class="fa fa-eye"></i></a>',
                    '<a href="' . route('wallets.edit', $item->id) . '" class="btn btn-success" title="' . __('Edit') . '"><i class="fa fa-pencil"></i></a>',
                    '<a class="btn btn-danger" href="#" onclick="if(confirm(\'' . __('Do You really want to delete this wallet?') . '\')) document.getElementById(\'delete-' . $item->id . '\').submit()" title="' . __('Delete') . '"><i class="fa fa-trash"></i></a>',
                    '</div>',
                ]);
